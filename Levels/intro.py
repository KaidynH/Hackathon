...
async def intro():
    ...
    nut_animation = image((300, 350), (90,90), "nut.png", rot=40)
    basket_animation = image((300, 1082), (150,150), "basket.png")
    animations = pygame.sprite.Group(bg_animation, branch_animation, nut_animation, basket_animation)
    ...
    while run:
        ...
        if frame <= 45:
            ...
            if not fall_init:
                ...
                fall_init = True
            bg_fall = bg_animation.glide(bg_glide)
            nut_fall = nut_animation.glide(nut_glide)
            branch_fall = branch_animation.glide(branch_glide)
            basket_fall = basket_animation.glide(basket_glide)
            print(nut_fall)
